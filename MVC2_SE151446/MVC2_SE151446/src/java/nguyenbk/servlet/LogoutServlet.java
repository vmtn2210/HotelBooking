            ...
            if(session != null){
                Cookie[] cookies = request.getCookies();
                    for (Cookie cooky : cookies) {
                        if(cooky.getName().equals(session.getAttribute("USERNAME")) && cooky.getValue().equals(session.getAttribute("PASSWORD"))){
                            String newValue = "DKAJDADDA";
                            cooky.setValue(newValue);
