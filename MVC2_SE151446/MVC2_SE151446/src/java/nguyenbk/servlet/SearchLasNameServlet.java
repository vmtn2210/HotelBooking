 ...
 * @author buikh
 */
@WebServlet(name = "SearchLasNameServlet", urlPatterns = {"/SearchLasNameServlet"})
public class SearchLasNameServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if(searchValue.trim().length() > 0){
                ...
                List<LoginDTO> result = dao.getAccounts();
